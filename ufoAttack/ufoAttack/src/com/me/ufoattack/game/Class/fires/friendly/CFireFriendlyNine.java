...
public class CFireFriendlyNine extends AFireFriendly{

	public CFireFriendlyNine() {
		super();
	}
	...
	protected Rectangle rectleft2HorizontalBullet;
	protected Rectangle rectright2HorizontalBullet;
	...
	public void init(Rectangle parentRect, GameScreen game) {
		...
		rectleftHorizontalBullet = new Rectangle(this.rect.x,this.rect.y-32, 32 ,32);
		rectleft2HorizontalBullet = new Rectangle(this.rect.x,this.rect.y-64, 32 ,32);
		
		rectrightHorizontalBullet = new Rectangle(this.rect.x +this.rect.width,this.rect.y-32, 32 ,32);
		rectright2HorizontalBullet = new Rectangle(this.rect.x +this.rect.width,this.rect.y-64, 32 ,32);
	...
	public void render(SpriteBatch batch, float deltaTime) {
		...
		batch.draw(this.leftHorizontalBulletRegion, this.rectleft2HorizontalBullet.x, this.rectleft2HorizontalBullet.y,32,32);
		batch.draw(this.rightHorizontalBulletRegion, this.rectrightHorizontalBullet.x, this.rectrightHorizontalBullet.y,32,32);
		batch.draw(this.rightHorizontalBulletRegion, this.rectright2HorizontalBullet.x, this.rectright2HorizontalBullet.y,32,32);
	...
	public void update(float time) {
		...
		while(iter.hasNext()) {
	      ...
	      if (this.rect.y < this.game.rectangleScreenSize.height) {
				...
				rectleft2HorizontalBullet.x -= this.speed/2;
				rectright2HorizontalBullet.x += this.speed/2;
	      } else {
	    	  this.alive = false;
	      }
	}
