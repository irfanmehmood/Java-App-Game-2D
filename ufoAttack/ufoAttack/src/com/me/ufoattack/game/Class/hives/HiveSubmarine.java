...
public class HiveSubmarine extends AHive{

	public HiveSubmarine() {
		super();
	...
	public static final Pool<HiveSubmarine> hiveSubmarinePool = Pools.get(HiveSubmarine.class);
	@Override
	public void reset() {
		...
		HiveSubmarine.hiveSubmarinePool.free(this);
